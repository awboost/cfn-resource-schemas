...
/**
 * Type definition for `AWS::QuickSight::DataSource.S3TablesParameters`.
 * @see {@link https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-datasource-s3tablesparameters.html}
 */
