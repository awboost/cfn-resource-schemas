...
export class RTBFabricOutboundExternalLink extends $Resource<
  ...
  RTBFabricOutboundExternalLinkProperties,
  RTBFabricOutboundExternalLinkAttributes
> {
  public static readonly Type = "AWS::RTBFabric::OutboundExternalLink";
  constructor(
    logicalId: string,
    properties: RTBFabricOutboundExternalLinkProperties,
