...
/**
 * Type definition for `AWS::ObservabilityAdmin::TelemetryRule.RegionStatus`.
 * Status of a telemetry rule in a specific region
 * @see {@link https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-observabilityadmin-telemetryrule-regionstatus.html}
 */
