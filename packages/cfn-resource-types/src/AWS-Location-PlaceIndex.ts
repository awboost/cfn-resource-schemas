...
/**
 * Type definition for `AWS::Location::PlaceIndex.Tag`.
 * A key-value pair to associate with a resource.
 * @see {@link https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-location-placeindex-tag.html}
 */
export type Tag = {
  /**
