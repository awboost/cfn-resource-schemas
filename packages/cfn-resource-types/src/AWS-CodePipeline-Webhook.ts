...
/**
 * Type definition for `AWS::CodePipeline::Webhook.Tag`.
 * A key-value pair to associate with a resource.
 * @see {@link https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codepipeline-webhook-tag.html}
 */
export type Tag = {
  /**
